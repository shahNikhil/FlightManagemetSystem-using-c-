...
GO
PRINT N'Creating [dbo].[BookingDetails].[IX_customerId]...';


GO
CREATE NONCLUSTERED INDEX [IX_customerId]
    ON [dbo].[BookingDetails]([Customer_ID] ASC);


GO
PRINT N'Creating [dbo].[BookingDetails].[IX_CarrierId]...';


GO
CREATE NONCLUSTERED INDEX [IX_CarrierId]
    ON [dbo].[BookingDetails]([Carrier_ID] ASC);
...
GO
PRINT N'Creating [dbo].[Carrier].[IX_Carrier_ID]...';
...
GO
PRINT N'Creating [dbo].[FK_Carrier]...';


GO
ALTER TABLE [dbo].[FlightDetails]
    ADD CONSTRAINT [FK_Carrier] FOREIGN KEY ([Carrier_ID]) REFERENCES [dbo].[Carrier] ([Carrier_ID]);
